  ...
  const texts: Record<string, Record<string, string>> = {
    es: {
      ...
      disponible: '¿Listo para empezar? Estoy disponible para proyectos freelance',
       title1: 'Apasionado por tecnología y música',
       descripcion1: 'Combino creatividad musical con soluciones tecnológicas.',
      ...
      bullets1: 'Guitarra eléctrica y bajo — interpretación en vivo',
    ...
    en: {
      ...
      subtitle: 'Building amazing digital experiences with passion and clean code',
      ...
      bullets1: 'Electric guitar and bass — live performance',
